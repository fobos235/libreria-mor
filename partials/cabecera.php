...
<?php
    ...
    <nav>
        <div class="nav-wrapper blue-grey">
            ...
            <ul class="right hide-on-med-and-down">
                <li><a class="waves-effect waves-light" href="categorias">Categorías</a></li>
                <li><a class="waves-effect waves-light" href="#!">Lo más vendido</a></li>
                <li><a class="waves-effect waves-light" href="usr/carrito"><i class="material-icons prefix">local_grocery_store</i></a></li>
    ...
    <ul class="sidenav waves-effect" id="mobile-demo">
        ...
        <?php if($_SESSION['rol'] == 2){ ?>
            <li><a class="waves-effect waves-light" href="#">Ver carrito</a></li>
        <?php }else{}?>
        <li><a href="perfil">Perfil</a></li>
        <li><a href="#!">Pedidos</a></li>
        <li class="divider"></li>
