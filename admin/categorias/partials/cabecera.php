<?php
    ...
    <ul id="dropdown1" class="dropdown-content">
     ...
     <nav>
        <div class="nav-wrapper blue-grey">
            <a href="/alpha-lib/" class="brand-logo"><h5>Librería Morelos</h5></a>
            <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
            <ul class="right hide-on-med-and-down">
                <li><a class="waves-effect waves-light" href="../panel_libro">Libros</a></li>
                <li><a class="waves-effect waves-light" href="#!">Comentarios</a></li>
    ...
    <ul class="sidenav" id="mobile-demo">
        ...
        <li><a href="#!">Pedidos</a></li>
        <li class="divider"></li>
        <li><a href="#!">Cerrar sesión<i class="material-icons right">exit_to_app</i></a></li>
    </ul>
    </ul>
