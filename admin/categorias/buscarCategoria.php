...
<body>
    <div class="container">
        ...
        $db=$database->open();
        $sql = $db->prepare("SELECT * FROM categoria"); 
        $sql->execute();
        while($fila = $sql->fetch()) {
            ...
            ?>
                <tr>
                    ...
                    <td><a href="editCategoria?idCat=<?php echo $fila['idCat'];?>" class="btn-flat waves-effect btn">Editar <i class="material-icons right">edit</i></a></td>
                </tr>
                <?php
        }
        ?>
