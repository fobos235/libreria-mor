...
<body>
    <div class="container">
		...
		$db=$database->open();
		try {
        $sql = $db->prepare("SELECT * FROM usuarios WHERE rol=1"); 
        $sql->execute();
        while($resultado = $sql->fetch()) {   
            ?>
                ...
                <td><a href="editAdmin?idAdmin=<?php echo $resultado['idUsuario'];?>" class="btn-flat waves-effect btn">Editar <i class="material-icons right">edit</i></a></td>
                </tr>
                <?php
		}
